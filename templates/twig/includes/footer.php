...
<footer class="the_footer"><!-- begin footer tag and give it an id-->
    ...
    <ul class="footer_list"><!-- begin unordered footer link list opening tag -->
        <li class="footer_item"><a href="../index.php?action=index" class="footer__link">Welcome</a></li>
        <!-- footer link list item -->
        <li class="footer_item"><a href="../history.php?action=history" class="footer__link">History</a></li>
        <!-- footer link list item -->
        <li class="footer_item"><a href="../news.php?action=news" class="footer__link">News</a></li>
        <!-- footer link list item -->
        <li class="footer_item"><a href="../shop.php?action=shop" class="footer__link">Shop</a></li>
        <!-- footer link list item -->
        <li class="footer_item"><a href="../contact.php?action=contact" class="footer__link">Contact Us</a></li>
        <!-- footer link list item -->
        <li class="footer_item"><a href="../obituary.php?action=obituary" target="_blank">Obituary</a></li>
        <!-- footer link list item -->
        <li class="footer_item"><a href="../site_map.php?action=site_map" class="footer__link">Site Map</a></li>
        <!-- footer link list item -->
    ...
    <div class="footer_contact_details"><!-- begin div to hold footer contact details -->
        <ul><!-- begin unordered contact details link list -->
            ...
            <li><a href="mailto:stjosephsparish1941@gmail.com">stjosephsparish1941@gmail.com</a></li>
            <!-- list item church email -->
