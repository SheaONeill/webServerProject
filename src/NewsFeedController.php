...
class NewsFeedController
{
     ...
     * if false it returns an error message
     */
    public function showCreateNewsArticleAction()
    {
        $isLoggedIn = $this->loginController->isLoggedInFromSession();
        $username = $this->loginController->usernameFromSession();
     ...
     * if false it returns an error message
     */
    public function showEditNewsArticleAction()
    {
        $isLoggedIn = $this->loginController->isLoggedInFromSession();
        $username = $this->loginController->usernameFromSession();
     ...
     */
    public function createNewsArticleAction()
    {
     ...
     */
    public function editNewsArticleAction()
    {
     ...
     * it returns an error message if creation fails
     */
    public function deleteNewsArticleAction()
    {
        $id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
